                ...
                <form method="post" action="create_auction_result.php">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <small id="titleHelp" class="form-text text-muted"><span class="text-danger">*
                                    Required.</span> A short description of the item you're selling, which will display
                                in listings.</small>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="auctionDetails" id="auctionDetails"
                                rows="4"></textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <small id="endDateHelp" class="form-text text-muted"><span class="text-danger">*
                                    Required.</span> Day for the auction to end.</small>
                        </div>
                    </div>
