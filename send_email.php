...
include '../function/phpmailer/src/Exception.php';
include '../function/phpmailer/src/PHPMailer.php';
include '../function/phpmailer/src/SMTP.php';
$mail = new PHPMailer(true); 
try {
    //服务器配置
$mailconfig=json_decode('{"Host":"smtp.163.com","Username":"cdzhj1012@163.com","Password":"password","SMTPSecure":"ssl","Port":465}');
